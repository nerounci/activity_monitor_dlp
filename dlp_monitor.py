...
"""
╔══════════════════════════════════════════════════════════════════╗
║      DLP-Монитор — прототип агента сбора данных + дашборд       ║
║      Курсовая работа: DLP-система (активность пользователей)    ║
╚══════════════════════════════════════════════════════════════════╝

Запуск:
    pip install psutil watchdog pywin32 wmi flask
...
# ─────────────────────────────────────────────────────────────────────────────
# Модуль 1: База данных (thread-safe SQLite)
# ─────────────────────────────────────────────────────────────────────────────
...
class Database:
    ...
    def get_recent_events(self, limit: int = 100) -> list[dict]:
        """
        UNION ALL по четырём таблицам: возвращает единую ленту событий,
...
# ─────────────────────────────────────────────────────────────────────────────
# Модуль 2: Вспомогательный расчёт риск-скора
# ─────────────────────────────────────────────────────────────────────────────
...
# ─────────────────────────────────────────────────────────────────────────────
# Модуль 3: Мониторинг активных окон
# ─────────────────────────────────────────────────────────────────────────────
...
# ─────────────────────────────────────────────────────────────────────────────
# Модуль 4: Мониторинг процессов
# ─────────────────────────────────────────────────────────────────────────────

class ProcessMonitor:
    """
    Сравнивает снимки PID-пространства: {pid: Process}.
    Разность множеств new - old = запущенные, old - new = завершённые.
...
# ─────────────────────────────────────────────────────────────────────────────
# Модуль 7: Встроенный веб-дашборд (Flask)
# ─────────────────────────────────────────────────────────────────────────────
